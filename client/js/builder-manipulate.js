/**
 * Client-side copy — src/builder-manipulate.js is the canonical source used
 * by tests. Pure geometry + decision logic for on-canvas direct
 * manipulation of builder objects (design doc
 * build_mode_ui_redesign_feature_design.md §8.2/§8.3/§8.4/§8.5). Kept
 * dependency-free from the canvas/DOM so the math is unit-testable;
 * client/js/main.js wires the actual pointer events.
 *
